...
time. It is definitely up there on my list of most pschologically
...
qwerty in 6th grade, by middle school had a mandatory typing class).
...
experience is worth anything. I can't say anything about it's
...
down than down. If keys are on the bottom row, they common ones should
...
Now, actions that work on seletions are on the right hand home row:
+ =d= :: copy
+ =D= :: yank
+ =n= :: change
...
convienient and shallow bindings for many very useful smartparens
...
nyaatouch, insert just inserts whereever your cursor actually is.
**** Utility functions
