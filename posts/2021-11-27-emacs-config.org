...
** Auto-revert prog modes
#+BEGIN_SRC emacs-lisp
(add-hook 'prog-mode #'auto-revert-mode)
#+END_SRC
...
**** Racket
for some reason, racket-mode is not loaded automatically... need to investigate.
#+BEGIN_SRC emacs-lisp
(use-package racket-mode
  :straight t)

(add-fs-to-hook 'racket-mode-hook rainbow-delimiters-mode aggressive-indent-mode)
(when (executable-find "racket")
  (add-fs-to-hook 'racket-mode-hook racket-xp-mode))

(use-package scribble-mode
  :straight t)
#+END_SRC

I use [[https://docs.racket-lang.org/qi/index.html][qi]], a dsl for piping. This introduces several new syntactical
constructs I use frequently:
...
(sup 'fstar-mode)
(setq-default fstar-executable "fstar")
#+END_SRC
