...
remember particularly well getting badly stuck deriving =liftM2= while
...
languages, like [[https://en.wikipedia.org/wiki/Common_Lisp_Object_System][object oriented systems]], [[https://clojure.org/guides/spec][runtime data validation]],
[[https://clojure.github.io/core.async/walkthrough.html][async programming]], crazy [[https://www.lispworks.com/documentation/HyperSpec/Body/m_loop.htm#loop][loop]] facilities, and even [[https://github.com/coalton-lang/coalton][static types]].
